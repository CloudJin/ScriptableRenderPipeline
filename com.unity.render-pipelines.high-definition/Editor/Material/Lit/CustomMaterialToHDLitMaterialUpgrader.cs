...
{
    class CustomMaterialToHDLitMaterialUpgrader : MaterialUpgrader
    {
        static readonly string Standard = "Standard (MSAO)";
        static readonly string Standard_Spec = "Standard (Specular setup)";
        static readonly string Standard_Rough = "Autodesk Interactive";

        public CustomMaterialToHDLitMaterialUpgrader(string sourceShaderName, string destShaderName, MaterialFinalizer finalizer = null)
        {
