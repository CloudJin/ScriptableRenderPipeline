...
{
    class SpeedTreeToHDLitMaterialUpgrader : MaterialUpgrader
    {
        static readonly string Standard = "Nature/SpeedTree2";
        static readonly string Standard_Spec = "Standard (Specular setup)";
        static readonly string Standard_Rough = "Autodesk Interactive";

        public SpeedTreeToHDLitMaterialUpgrader(string sourceShaderName, string destShaderName, MaterialFinalizer finalizer = null)
        {
